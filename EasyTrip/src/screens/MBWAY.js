...
function MBWAY({route,navigation}) {
    ...
    function comprarTitulo(){
        ...
        if(numeroTelemovel.length==9){
            ...
            Alert.alert("Número de telemóvel incorreto", "Por favor coloque um número de telemóvel válido")
        }
