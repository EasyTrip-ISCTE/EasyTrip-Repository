...
function VISA({route, navigation}) {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputCampos}>
                <Text style={styles.inputMontante}>Montante: {route.params.titulo.IsZapping ? route.params.titulo.ValorZapping : route.params.titulo.titulo.Valor}€</Text>
            </View>
            <View style={styles.inputCampos}>    
                    <TextInput 
